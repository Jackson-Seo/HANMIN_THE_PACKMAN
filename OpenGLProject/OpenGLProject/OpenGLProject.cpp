...
COpenGLProjectApp::COpenGLProjectApp() noexcept
{
	...
	SetAppID(_T("OpenGLProject.AppID.NoVersion"));
...
BOOL COpenGLProjectApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(COpenGLProjectDoc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(COpenGLProjectView));
	if (!pDocTemplate)
		return FALSE;
...
int COpenGLProjectApp::ExitInstance()
{
...
void COpenGLProjectApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
void COpenGLProjectApp::LoadCustomState()
{
}

void COpenGLProjectApp::SaveCustomState()
{
}
