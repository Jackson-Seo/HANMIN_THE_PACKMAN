...
void COpenGLProjectView::initGL()
{
	...
	*/
	// ObjectManager::LoadObject(shaderManager->glslShader, "../OpenGLProject/Asset/IronMan.obj");
	// ObjectManager::LoadObject(shaderManager->glslShader, "../OpenGLProject/Asset/Kizuna/kizunaai.obj");
	ObjectManager::LoadObject(shaderManager->glslShader, "../OpenGLProject/Asset/Air/Aircraft.obj");
	// ObjectManager::LoadObject(shaderManager->glslShader, "../OpenGLProject/Asset/h/Handgun.obj");
