...
void DefaultPlane::plane::settingPlane(void)
{
	...
	unsigned char* data = stbi_load("../OpenGLProject/Textures/PlaneTextureGray.jpg", &width, &height, &nrChannels, 0);
	if (data)
	{
...
void DefaultPlane::plane::caltranslate(const Shader& shader)
{
...
void DefaultPlane::plane::drawPlane(void)
{
